 ...
 * @author saulg
 */
@WebServlet(name = "SaulTarea4", urlPatterns = {"/SaulTarea4"})
public class SaulTarea4 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
             ...
             ProcessBuilder pbCompilar = new ProcessBuilder(
                ...
                "-d", "bin",
                "-cp", "src",
                "src/aiae_practica2/*.java"
            );
            pbCompilar.directory(new File("C:/Users/saulg/OneDrive/Trimestre24O/AIAE/Proyecto_Final/AIAE_Practica2"));
           ...
           ProcessBuilder pbEjecutar = new ProcessBuilder(
                "java",
                "-cp", "bin",
                "aiae_practica2.Principal"
            );
            pbEjecutar.directory(new File("C:/Users/saulg/OneDrive/Trimestre24O/AIAE/Proyecto_Final/AIAE_Practica2"));
