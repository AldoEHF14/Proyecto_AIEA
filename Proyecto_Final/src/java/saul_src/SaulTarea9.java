 ...
 * @author saulg
 */
@WebServlet(name = "SaulTarea9", urlPatterns = {"/SaulTarea9"})
public class SaulTarea9 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Saul Tarea 9</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h3>"+libro.toString()+"</h3>");
