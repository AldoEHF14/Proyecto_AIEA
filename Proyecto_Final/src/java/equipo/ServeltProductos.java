 ...
 * @author Aldoh
 */
@WebServlet(name = "ServeltProductos", urlPatterns = {"/ServeltProductos"})
public class ServeltProductos extends HttpServlet {
...
//        processRequest(request, response);
        ...
        Libro libro = new Libro(nombre, image, autor, precio, descripcion);
...
//            agregarProductoTipo1(out, book.getImg(), book.getNombre(), book.getAutor(), book.getDescripcion(),Integer.parseInt(book.getPrecio().toString()));
//        }

        for (Libro book: libros){
            agregarProductoTipo1(out, "./ruta/default", book.getNombre(), book.getAutor(), book.getDescripcion(),Integer.parseInt(book.getPrecio()));
        }
